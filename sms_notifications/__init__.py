...
sms_notifications = Blueprint(APP_NAME, __name__, url_prefix='/{0}'.format(APP_NAME),
    template_folder='templates')

# @sms_notifications.app_errorhandler(404)
@sms_notifications.app_errorhandler(403)
def handle_403(err):
...
@sms_notifications.app_errorhandler(500)
def handle_500(err):

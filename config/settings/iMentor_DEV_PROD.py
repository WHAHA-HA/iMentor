...
# This is a hybrid: using dev code on the dev box, with an unmodified copy of the prod DB. 
...
PORT = 5000
BASE_URL = "https://{}:{}/".format(BASE_SITENAME, PORT)

ENV_TYPE="Dev_Running_Prod_DB_Copy"

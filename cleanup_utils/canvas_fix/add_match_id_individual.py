...
if __name__ == "__main__":
    ...
    user_ids = [151666, 151667, 156367, 156917, 133071, 155925, 136827, 176236, 155941, 180899, 193156, 191000, 192923, 193618, 188623]

    responses = local_db_session.query(WidgetContentUserResponse).filter(
        WidgetContentUserResponse.user_id.in_(user_ids)).all()

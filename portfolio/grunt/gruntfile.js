  ...
  grunt.initConfig({
    ...
    ngAnnotate: {
        ...
        app: {
            files: [
                {
                    expand: true,
                    cwd: '<%= pkg.approot %>static/portfolio/js',
                ...
                },
                {
                    ...
                    src: [
                        ...
                        'static/conversations/scripts/index2.js',
    ...
    cssmin: {
      ...
      build: {
        files: [{
                expand: true,
                cwd: '<%= pkg.approot %>static/portfolio/css',
                src: ['./**/*.css','!./production/*'],
                dest: '<%= pkg.temp %>css',
                ext: '.css'
            },
            {
                ...
                src: [
                    ...
                    'static/textAngular/textAngular.custom.css',
      ...
      production: {
        files: [{
                '<%= pkg.approot %>static/portfolio/css/production/libs.min.css': [
                ...
                '<%= pkg.approot %>static/portfolio/css/production/app.min.css': [
                    '<%= pkg.temp %>css/static/hambuger-menu/header-bar-universal.css',
                    '<%= pkg.temp %>css/portfolio.css',
                    '<%= pkg.temp %>css/static/textAngular/textAngular.custom.css',
    ...
    concat: {
        ...
        production:{
            files: {
                '<%= pkg.approot %>static/portfolio/js/production/libs.min.js': [
                    ...
                    '<%= pkg.libs %>textAngular/textAngularSetup-brackets.js',
                ...
                '<%= pkg.approot %>static/portfolio/js/production/app.min.js': [
                    ...
                    '<%= pkg.temp %>js/portfolio.js',
                    '<%= pkg.temp %>js/templates.js',
                    '<%= pkg.temp %>js/static/conversations/scripts/index2.js',
    ...
    jshint: {
        dev: {
            src: [
                'gruntfile.js',
                '<%= pkg.approot %>static/portfolio/js/*.js', 
                '<%= pkg.approot %>static/portfolio/test/*.js',
                '!<%= pkg.approot %>static/portfolio/js/production/*'
            ],
            options: {
    ...
    watch: {
        ...
        scripts: {
            files: '<%= pkg.approot %>static/portfolio/js/**/*.js',
            tasks: ['jshint'],
            options: {
              spawn: false
            }
    ...
    copy: {
        build: {
            files: [
                ...
                // Get data
                {
                    cwd: '<%= pkg.approot %>static/portfolio/data/',
                    src: ['./**/*.*'],
                    dest: '<%= pkg.build %>data/',
                    expand: true,
                    flatten: false,

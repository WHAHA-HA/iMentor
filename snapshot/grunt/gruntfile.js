  ...
  grunt.initConfig({
    ...
    ngAnnotate: {
        ...
        app: {
            files: [
                {
                    expand: true,
                    cwd: '<%= pkg.approot %>static/snapshot/js',
    ...
    cssmin: {
      ...
      build: {
        files: [{
                expand: true,
                cwd: '<%= pkg.approot %>static/snapshot/css',
                src: ['./**/*.css','!./production/*'],
                dest: '<%= pkg.temp %>css',
                ext: '.css',
                extDot: 'last',       // Extensions in filenames begin after the last dot
      ...
      production: {
        files: [{
                '<%= pkg.approot %>static/snapshot/css/production/libs.min.css': [
                ...
                '<%= pkg.approot %>static/snapshot/css/production/app.min.css': [
                    '<%= pkg.temp %>css/classroom_mgmt.css',
    ...
    concat: {
        ...
        production:{
            files: {
                '<%= pkg.approot %>static/snapshot/js/production/libs.min.js': [
                ...
                '<%= pkg.approot %>static/snapshot/js/production/app.min.js': [
                    ...
                    '<%= pkg.temp %>js/angular-init.js',
                    '<%= pkg.temp %>js/controllers.js',
    ...
    jshint: {
        dev: {
            src: [
                'gruntfile.js',
                '<%= pkg.approot %>static/snapshot/js/*.js', 
                '<%= pkg.approot %>static/snapshot/test/*.js',
                '!<%= pkg.approot %>static/snapshot/js/production/*'
            ],
            options: {
    ...
    watch: {
        ...
        scripts: {
            files: '<%= pkg.approot %>static/snapshot/js/**/*.js',
            tasks: ['jshint'],
            options: {
              spawn: false
            }
    ...
    copy: {
        build: {
            files: [
                ...
                // Get data
                {
                    cwd: '<%= pkg.approot %>static/snapshot/data/',
                    src: ['./**/*.*'],
                    dest: '<%= pkg.build %>data/',
                    expand: true,
                    flatten: false,

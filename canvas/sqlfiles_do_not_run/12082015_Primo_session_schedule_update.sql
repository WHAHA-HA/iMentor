...
DELETE from reporting_matchcompletesession * WHERE session_id = 36452;
--35 rows. 35 affected.

DELETE from partners_session_curriculum * WHERE id = 114;
--1 row. 1 affected.

DELETE from partners_session * WHERE id = 36452;
--1 row. 1 affected.

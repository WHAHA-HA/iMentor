...
where csc.parent_id in (85,86,87)
	and csc.persona_id in (select persona_id from iuser_persona_partners where partner_id = 2423)
...
--390 rows. 64 affected.

/*
select * from canvas_curriculum_copy where user_id = 176108 order by end_datetime asc
select * from canvas_set_copy where user_id = 176108 order by end_datetime asc
select id, email from iuser_user where id = 176108

select * from canvas_set_copy where id = 27201
select partner_id from iuser_persona_partners where persona_id = 95521
select id, name from partners_partner where id = 2423
*/
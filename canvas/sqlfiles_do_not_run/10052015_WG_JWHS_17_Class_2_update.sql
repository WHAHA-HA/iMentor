...
--2129, JWHS '17 Class 2, "Who's Who In School?"
...
SET sess_id = 35949
WHERE id IN (SELECT id FROM reporting_allmatchemail WHERE partner_id = 2129 AND send_date BETWEEN '2015-05-19 11:00:00-04' AND '2015-08-13 03:59:59-04');
--53 rows.

--2129, JWHS '17 Class 2, "Refresh and Reconnect"

UPDATE partners_session
SET start = '2015-08-13 04:00:00-04', end_date = '2015-09-08 14:14:59-04'
WHERE id = 36488;
--1 row.

UPDATE reporting_allmatchemail
SET sess_id = 36488
WHERE id IN (SELECT id FROM reporting_allmatchemail WHERE partner_id = 2129 AND send_date BETWEEN '2015-08-13 04:00:00-04' AND '2015-09-08 14:14:59-04');
--20 rows.

UPDATE canvas_set_copy
SET start_datetime = '2015-08-13 04:00:00-04', end_datetime = '2015-09-08 14:14:59-04'
WHERE id IN (
SELECT
	csc.id
...
--2129, JWHS '17 Class 2, "About Us"

UPDATE partners_session
SET start = '2015-09-08 14:15:00-04', end_date = '2015-09-17 13:59:59-04'
WHERE id = 36411;
--1 row.

UPDATE reporting_allmatchemail
SET sess_id = 36411
WHERE id IN (SELECT id FROM reporting_allmatchemail WHERE partner_id = 2129 AND send_date BETWEEN '2015-09-08 14:15:00-04' AND '2015-09-17 13:59:59-04');
--40 rows.

UPDATE canvas_set_copy
SET start_datetime = '2015-09-08 14:15:00-04', end_datetime = '2015-09-17 13:59:59-04'
WHERE id IN (
SELECT
	csc.id
FROM canvas_set_copy AS csc
...
--2129, JWHS '17 Class 2, "Survey"

UPDATE partners_session
SET start = '2015-09-17 14:00:00-04', end_date = '2015-09-22 13:59:59-04'
WHERE id = 36573;
--1 row.

UPDATE reporting_allmatchemail
SET sess_id = 36573
WHERE id IN (SELECT id FROM reporting_allmatchemail WHERE partner_id = 2129 AND send_date BETWEEN '2015-09-17 14:00:00-04' AND '2015-09-22 13:59:59-04');
--9 rows.

UPDATE canvas_set_copy
SET start_datetime = '2015-09-17 14:00:00-04', end_datetime = '2015-09-22 13:59:59-04'
WHERE id IN (
SELECT
	csc.id
FROM canvas_set_copy AS csc
...
select * from partners_session where partner_id = 2129 order by start desc limit 15;

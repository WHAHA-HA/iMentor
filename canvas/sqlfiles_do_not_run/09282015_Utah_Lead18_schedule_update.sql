...
--2322, Leaders in Action '18, "Survey"

UPDATE partners_session
SET start = '2015-09-10 13:00:00-04', end_date = '2015-09-17 14:29:59-04'
WHERE id = 36390;

UPDATE reporting_allmatchemail
SET sess_id = 36390
WHERE id IN (SELECT id FROM reporting_allmatchemail WHERE partner_id = 2322 AND send_date BETWEEN '2015-09-10 13:00:00-04' AND '2015-09-17 14:29:59-04');
--0 rows

UPDATE canvas_set_copy
SET start_datetime = '2015-09-10 13:00:00-04', end_datetime = '2015-09-17 14:29:59-04'
WHERE id IN (
SELECT
	csc.id
...
--2322, Leaders in Action '18, "About Us"
...
UPDATE reporting_allmatchemail
SET sess_id = 36614
WHERE id IN (SELECT id FROM reporting_allmatchemail WHERE partner_id = 2322 AND send_date BETWEEN '2015-09-17 14:30:00-04' AND '2016-02-17 14:30:00-04');
--0 rows
...
select * from partners_session where partner_id = 2322 order by start desc limit 15;

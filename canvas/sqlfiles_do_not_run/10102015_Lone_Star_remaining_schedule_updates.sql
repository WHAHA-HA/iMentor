...
--1992, Kimball 2017C, "10th Grade Reflection - Last Prompt"

UPDATE partners_session
SET start = '2015-05-12 13:00:00', end_date = '2015-09-08 20:29:59'
WHERE id = 35828;
--1 row.

--1993, Kimball 2017D, "10th Grade Reflection - Last Prompt"

UPDATE partners_session
SET start = '2015-05-12 13:00:00', end_date = '2015-09-16 23:44:59'
WHERE id = 35829;
--1 row.

--2005, KIPP 2017A, "It's Summer! [Free Write]"

UPDATE partners_session
SET start = '2015-06-09 05:00:00', end_date = '2015-09-16 15:59:59'
WHERE id = 36210;
--1 row.

--2006, KIPP 2017B, "It's Summer! [Free Write]"

UPDATE partners_session
SET start = '2015-06-09 05:00:00', end_date = '2015-09-15 15:59:59'
WHERE id = 36211;
--1 row.

--2007, KIPP 2017C, "It's Summer! [Free Write]"
...
--2008, KIPP 2017D, "It's Summer! [Free Write]"
...
--2229, KIPP 2017E, "It's Summer! [Free Write]"
...
--2246, North Dallas 2018B, "Pushing Through It"

UPDATE partners_session
SET start = '2015-03-18 15:00:00', end_date = '2015-09-16 09:59:59'
WHERE id = 34413;
--1 row.

--2247, North Dallas 2018C, "Pushing Through It"

UPDATE partners_session
SET start = '2015-03-18 15:00:00', end_date = '2015-09-22 12:59:59'
WHERE id = 34414;
--1 row.

--2230, Reagan 2018A, "Summer"

UPDATE partners_session
SET start = '2015-06-09 13:00:00', end_date = '2015-09-15 17:49:59'
WHERE id = 36200;
--1 row.
...
WITH session_email_details AS (
	...
	WHERE ra.send_date::TIMESTAMPTZ AT TIME ZONE 'UTC' >= ps.start
		...
		AND ps.partner_id IN (1992, 1993, 2005, 2006, 2007, 2008, 2229, 2246, 2247, 2230)
		AND ps.start::DATE >= '3/18/15'
	)
...
--2415 rows. 2403 affected.

/*
select id, description, partner_id, start, end_date from partners_session where partner_id = 2006 order by start desc limit 10;

select id, name from partners_partner where name ilike '%Reagan 2018A%';

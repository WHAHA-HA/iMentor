...
SET start = '2015-09-09 23:00:00', end_date = '2015-09-15 23:59:59'
WHERE id = 36380;
--1 row.

UPDATE canvas_set_copy
SET start_datetime = '2015-09-09 23:00:00', end_datetime = '2015-09-15 23:59:59'
WHERE id IN (
SELECT
	csc.id
...
UPDATE partners_session
SET start = '2015-09-16 00:00:00', end_date = '2016-02-18 18:00:00'
WHERE id = 36533;
--1 row.

UPDATE canvas_set_copy
SET start_datetime = '2015-09-16 00:00:00', end_datetime = '2016-02-18 18:00:00'
WHERE id IN (
SELECT
	csc.id
FROM canvas_set_copy AS csc

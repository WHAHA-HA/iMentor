...
--2140, Veritas '18 Class 1, "Introduction to iMentor"

UPDATE partners_session
SET start = '2015-08-16 00:00:01-04', end_date = '2015-08-23 03:59:59-04'
WHERE id = 36471;
--1 row.

UPDATE reporting_allmatchemail
SET sess_id = 36471
WHERE id IN (SELECT id FROM reporting_allmatchemail WHERE partner_id = 2140 AND send_date BETWEEN '2015-08-16 00:00:01-04' AND '2015-08-23 03:59:59-04');
--2 rows.

UPDATE canvas_set_copy
SET start_datetime = '2015-08-16 00:00:01-04', end_datetime = '2015-08-23 03:59:59-04'
WHERE id IN (
SELECT
	csc.id
...
--2140, Veritas '18 Class 1, "Refresh and Reconnect"

UPDATE partners_session
SET start = '2015-08-23 04:00:00-04', end_date = '2015-09-30 03:59:59-04'
WHERE id = 36406;
--1 row.

UPDATE reporting_allmatchemail
SET sess_id = 36406
WHERE id IN (SELECT id FROM reporting_allmatchemail WHERE partner_id = 2140 AND send_date BETWEEN '2015-08-23 04:00:00-04' AND '2015-09-30 03:59:59-04');
--41 rows.

UPDATE canvas_set_copy
SET start_datetime = '2015-08-23 04:00:00-04', end_datetime = '2015-09-30 03:59:59-04'
WHERE id IN (
SELECT
	csc.id
FROM canvas_set_copy AS csc

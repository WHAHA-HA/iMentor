...
--2131, Harding '18 Class 2, "Preview: Summer & Sophomore Year"

UPDATE partners_session
SET start = '2015-05-13 07:00:00-04', end_date = '2015-09-16 10:44:59-04'
WHERE id = 35798;
--1 row.

UPDATE reporting_allmatchemail
SET sess_id = 35798
WHERE id IN (SELECT id FROM reporting_allmatchemail WHERE partner_id = 2131 AND send_date BETWEEN '2015-05-13 07:00:00-04' AND '2015-09-16 10:44:59-04');
--46 rows.
...
select * from partners_session where partner_id = 2131 order by start desc limit 15;

(function() {
	...
	function SimpleChat($timeout) {
		var directive = {
			restrict: 'EA',
			templateUrl: '/new_platform/static/chat/templates/chatTemplate.html',
			replace: true,
			scope: {
				messages: '=',
				username: '=',
	...
	ChatCtrl.$inject = ['$scope', '$timeout', '$rootScope'];

	function ChatCtrl($scope, $timeout, $rootScope) {
		var vm = this;
		vm.isHidden = false;
		vm.messages = $scope.messages;
		vm.username = $rootScope.mentorId || $rootScope.menteeId;

...
.factory('dateFunc', function() {
    var func={};

    func.convert = function(originVal) {
      if (originVal===null)
        return null;

      var year = originVal.substring(2, 4);
      var month = originVal.substring(5,7);
      var date = originVal.substring(8,10);
